...
def test_warns_when_peer_mtls_pinning_off(tmp_path: Path, caplog: pytest.LogCaptureFixture) -> None:
    ...
    cfg = _write_config(
        ...
        peers={
            "mnemos-A": PeerConfig(
                bearer_token_env="VESMARO_FED_PEER_TOKEN",
...
def test_warns_per_peer_with_off_peer(tmp_path: Path, caplog: pytest.LogCaptureFixture) -> None:
    ...
    cfg = _write_config(
        ...
        peers={
            "mnemos-A": PeerConfig(
                bearer_token_env="VESMARO_FED_PEER_TOKEN_A",
                mtls_cert_fingerprint=None,
            ),
            "mnemos-B": PeerConfig(
                bearer_token_env="VESMARO_FED_PEER_TOKEN_B",
                mtls_cert_fingerprint=None,
            ),
            "mnemos-C": PeerConfig(
                bearer_token_env="VESMARO_FED_PEER_TOKEN_C",
