...
<!-- version:pip -->
```bash
pip install https://github.com/Korrnals/mnemos/releases/download/v4.2.0/mnemos_memory_server-4.2.0-py3-none-any.whl
```
<!-- /version:pip -->
...
<!-- version:tags -->
Теги: `:4.2.0` (фиксированная) · `:latest` (rolling).
<!-- /version:tags -->
