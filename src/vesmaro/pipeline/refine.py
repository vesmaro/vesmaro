...
from vesmaro.models import MemoryStatus, PipelineState
...
def _produce_refined_projection(mgr: MemoryManager, memory: Memory) -> str | None:
    ...
    mirrors :mod:`vesmaro.pipeline.synthesize`'s placeholder convention:
    ...
    * a cluster of >= 2 context-admissible entries produces a digest
    ...
    if not memory.cluster_id:
        return None
    from vesmaro.models import is_context_admissible
