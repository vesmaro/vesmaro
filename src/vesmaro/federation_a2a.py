...
message envelope and the :mod:`vesmaro.federation_server` /
:mod:`vesmaro.federation_client` pure functions. It does NOT contain
...
from vesmaro.federation_client import pull_from_peer
from vesmaro.federation_server import PullRequest, PullResponse, PullResult, handle_pull
from vesmaro.manager import MemoryManager
from vesmaro.trigger_codes import TriggerCode, should_fallback_to_local
...
def handle_request_info(
    ...
    *,
    ...
    :func:`vesmaro.federation_server.handle_pull`, and wraps the
