...
<!-- version:pip -->
```bash
pip install https://github.com/Korrnals/mnemos/releases/download/v2.11.0/mnemos-2.11.0-py3-none-any.whl
```
<!-- /version:pip -->
...
<!-- version:image -->
  ghcr.io/korrnals/mnemos:2.11.0
<!-- /version:image -->
...
<!-- version:tags -->
Теги: `:2.11.0` (фиксированная) · `:latest` (rolling). Работает и с `docker` — замените `podman` на `docker`.
<!-- /version:tags -->
