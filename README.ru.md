...
<!-- version:pip -->
```bash
pip install https://github.com/Korrnals/mnemos/releases/download/v2.13.0/mnemos-2.13.0-py3-none-any.whl
```
<!-- /version:pip -->
...
<!-- version:tags -->
Теги: `:2.13.0` (фиксированная) · `:latest` (rolling). Работает и с `docker` — замените `podman` на `docker`.
<!-- /version:tags -->
