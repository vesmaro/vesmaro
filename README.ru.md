...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-2.0.2-blueviolet" alt="Version"></a>
</p>
...
podman run -d --name mnemos \
  ...
  ghcr.io/korrnals/mnemos:2.0.2

curl -s http://localhost:8787/health | jq
```

Теги: `:2.0.2` (фиксированная) · `:latest` (rolling). Работает и с `docker` — замените `podman` на `docker`.
...
<p align="center">
  ...
  quality gate — ruff + mypy --strict + bandit + pip-audit + 209 тестов. Если зелёно — готово к публикации.</sub>
</p>