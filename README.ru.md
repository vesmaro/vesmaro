...
<!-- version:pip -->
```bash
pip install https://github.com/Korrnals/mnemos/releases/download/v2.14.1/mnemos-2.14.1-py3-none-any.whl
```
<!-- /version:pip -->
...
<!-- version:image -->
  ghcr.io/korrnals/mnemos:2.14.1
<!-- /version:image -->
...
<!-- version:tags -->
Теги: `:2.14.1` (фиксированная) · `:latest` (rolling). Работает и с `docker` — замените `podman` на `docker`.
<!-- /version:tags -->
